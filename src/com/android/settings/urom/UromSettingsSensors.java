...
public class UromSettingsSensors extends SettingsPreferenceFragment {
    ...
    private void writeAutoPowerOptions(boolean state) {
    ...
    private void writeSensorsSignificantOptions() {
        if (mSensorsSignificant.isChecked()) {
            ...
            mSensorsDialog = new AlertDialog.Builder(getActivity()).setMessage(
                    ...
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            /* AutoPowerMode depends on Significant Motion Sensor
                             * We set it to true by default if the significant motion sensor is enable
                             */
                            writeAutoPowerOptions(true);
                            rebootRequired();
                            updateSensorsSignificantOptions();
                        }
                    })
            ...
            mSensorsDialog = new AlertDialog.Builder(getActivity()).setMessage(
                    getResources().getString(R.string.sensors_significant_disable_warning))
                    .setTitle(R.string.sensors_significant_disable)
                    .setIconAttribute(android.R.attr.alertDialogIcon)
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                    ...
                    .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            // Reset
                            mSensorsSignificant.setChecked(true);
                        }
                    })
                    .show();
            mSensorsDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
