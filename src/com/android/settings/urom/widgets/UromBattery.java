...
public class UromBattery extends UromDialogPreference implements RadioGroup.OnCheckedChangeListener {
    ...
    private int[] mResIdStyle = new int[]{
            ...
            R.id.battery_style_dotted_circle_option,
    ...
    private int[] mStringIdStyle = new int[]{
            ...
            R.string.status_bar_battery_style_dotted_circle,
    ...
    private int getStyle() {
        return Settings.System.getInt(getContext().getContentResolver(),
                Settings.System.STATUS_BAR_BATTERY_STYLE, BATTERY_STYLE_DEFAULT);
    }

    private int getPercentage() {
        return Settings.System.getInt(getContext().getContentResolver(),
                Settings.System.STATUS_BAR_SHOW_BATTERY_PERCENT, BATTERY_PERCENTAGE_DEFAULT);
    }

    private void writeStyle(int mode) {
        Settings.System.putInt(getContext().getContentResolver(),
                Settings.System.STATUS_BAR_BATTERY_STYLE, mode);
    }

    private void writePercentage(int mode) {
        Settings.System.putInt(getContext().getContentResolver(),
                Settings.System.STATUS_BAR_SHOW_BATTERY_PERCENT, mode);
    }
    ...
    protected void onUromDialogPositive() {
        mOriginalStyle = mValuesStyle[findIndexOfValue(
                mStyleRadioGroup.getCheckedRadioButtonId(),
                mResIdStyle)];

        mOriginalPercentage = mValuesPercentage[findIndexOfValue(
                mPercentageRadioGroup.getCheckedRadioButtonId(),
                mResIdPercentage)];
